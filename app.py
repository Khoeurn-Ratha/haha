...
# Render PostgreSQL Database URL (Internal URL)
DEFAULT_RENDER_DB_URL = "postgresql://ramote_user:KB6MBdQ5zXkT5zDZ5APXNmBAVgUx6SDZ@dpg-da8k9vijnfac73emabgg-a/ramote"
RAW_DATABASE_URL = os.environ.get("DATABASE_URL", DEFAULT_RENDER_DB_URL).strip()
...
def trades_endpoint():
    ...
    if request.method == "GET":
        ...
        # Check today's stats
        cursor.execute(f"SELECT SUM(profit_loss) as day_pl, COUNT(*) as day_trades FROM trades WHERE trade_date = {placeholder}", (trade_date,))
...
def get_stats():
    ...
    return jsonify({
        ...
        "performance": {
            ...
            "wins": wins,
            "losses": losses,
            "breakevens": breakvevens if 'breakvevens' in locals() else breakevens,
            "win_rate": win_rate,
